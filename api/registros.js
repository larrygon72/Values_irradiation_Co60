...
function filaDesdeRegistro(r) {
  return {
    ...
    tiempo_exposicion_real: r.texpReal ? parseFloat(r.texpReal) : null,
    exposicion_usv: r.expUsv !== "" && r.expUsv != null ? parseFloat(r.expUsv) : null,
    ...
    irradiador_id: r.irrId || null,
    irradiador_nombre: r.irrNombre || null,
    irradiador_codigo: r.irrCodigo || null,
